...
create function example.rs(int) returns varchar as 'org.sourcewave.jinx.example.Example.randomString' language java;
create function example.property(varchar) returns varchar as 'java.lang.System.getProperty' language java;
create function example.properties() returns setof example.propertyType as 'java.lang.System.properties' language java;
...
create function example.countRows(varchar) returns int as 'org.sourcewave.jinx.example.Example.countRows' language java;
    
/*
    select * from getOptions() as (key varchar, val varchar) order by key;
    */
create or replace function example.getOptions() returns setof record as 'org.sourcewave.jinx.example.Example.getOptions' volatile language java;

create or replace function example.getGravatar() returns trigger as 'org.sourcewave.jinx.example.GravatarTrigger.xxx' volatile language java;
